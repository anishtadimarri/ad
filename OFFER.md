...
**Headline economics at operator parameters — $20,000 placed salary, 30% fee, 9-month average
worker stay, recruitment costed at one month of salary:**

| | CAC | 30-day GP | **30-day** | **Lifetime** |
|---|---|---|---|---|
| Conservative | $2,649 | $3,227 | **1.22:1** ⚠️ | 2.73:1 |
| **Base** | **$587** | **$4,091** (54%) | **6.97:1** | **16.28:1** |
| Optimistic | $347 | $4,286 | 12.36:1 | 38.23:1 |

Live figures in [`scoring/OFFER-MODEL.md`](scoring/OFFER-MODEL.md), generated by
[`scoring/offer_model.py`](scoring/offer_model.py). **§4 below still carries figures from an
earlier $34k / 35% pass — the model output supersedes it.**
