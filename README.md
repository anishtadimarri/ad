...
| **[`HUNGRY.md`](HUNGRY.md)** | **Bottlenecks, not cost centres** — 14 industry × seat pairs outside D2C. **A cost-centre buyer negotiates price; a bottleneck buyer asks how fast you can start.** Contractors × estimating wins; e-comm × bookkeeping is scored as the control and **gates out on `BOTTLENECK`=2** |
