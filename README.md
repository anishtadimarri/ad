...
**Long-term:** $100M via EOR + managed service, using placement as the acquisition engine
(SCALE.md). **Status:** pre-launch, nothing validated, no customer met.
...
| The number that decides the ceiling | **Clients per accountant** — 1:1 caps you at $15M, 1:3 unlocks $100M |
