...
| **[`NAMES.md`](NAMES.md)** | **THE RANKING.** 63 candidates × 7 dimensions under **two rankings** — descriptive vs arbitrary-brand — plus gates for collisions, surnames and audio-spelling leaks. `Talent` survives 13 head-noun challengers; **`Hires`** is the only improvement. **No bare single-word `.com` exists** (182 checked) |
