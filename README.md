...
| **[`NAMES.md`](NAMES.md)** | **THE RANKING.** 49 candidates × 7 dimensions, under **two rankings** — descriptive vs arbitrary-brand — because those disagree and *that* is the real decision. **No bare single-word `.com` exists** (182 checked). The **surname register** is the only one with inventory left, and all five global search leaders are surnames |
