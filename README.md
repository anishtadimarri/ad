...
| **[`NAMES.md`](NAMES.md)** | **THE RANKING.** 55 candidates × 7 dimensions under **two rankings** — descriptive vs arbitrary-brand — plus gates for collisions and for surnames. **Gumption Talent** is the only single generic word in the top five of both. **No bare single-word `.com` exists** (182 checked) |
