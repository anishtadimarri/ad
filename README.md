...
| **[`COMPETITOR-DATA.md`](COMPETITOR-DATA.md)** | **What Somewhere and Oceans actually sell** — 60+ published roles with rates, bookkeeper priced by country, and the finding that **neither of them sources India** | **§7: SkillArbitrage** — the closest analogue to this plan, built supply-first (25,000 learners paying ₹42-63k). **Three of three India analogues monetise the worker and give the employer away**, which is why the demand side is the untaken half |
