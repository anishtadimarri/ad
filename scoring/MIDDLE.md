...
| Offer | Ports | Best rank | Build days | Fields | `DESIRE` | Score |
|---|---|---|---|---|---|---|
| **"Three graded candidates in 7 days" — the shortlist promise** ✅ | **10** | 1 | 2.75 | 6 | 8 | 74.1 |
| **Get a price / instant quote** ✅ | **8** | 2 | 3 | 6 | 7 | 73.8 |
| **Book a call** | **10** | 7 | 0.85 | 5 | 4 | 71.7 |
| **See the graded bench** | **5** | 12 | 3.5 | 5 | 9 | 68.5 |
| **Monthly-spend comparison — what you pay now vs full-time** | **10** | 17 | 2.75 | 6 | 3 | 65.5 |
| ****The hiring scorecard** — download the test, score candidates yourself** | **8** | 20 | 3 | 6 | 1 | 64.2 |
| **Free custom work on their asset** | **2** | 42 | 2 | 4 | 9 | 60.2 |
| **Generic "contact us"** | **10** | 50 | 1.6 | 4 | 2 | 58.6 |
| **Paid micro-trial, $100–250** | **2** | 53 | 3 | 5 | 6 | 57.5 |
| **See the test — the rubric as an on-page block** | **9** | 57 | 3.5 | 6 | 1 | 56.3 |
| **Volume calculator — units × vendor unit cost** | **3** | 62 | 3.5 | 6 | 3 | 55.3 |
| **Free document — scorecard, salary data, guide** | **4** | 69 | 3.5 | 5 | 1 | 54.1 |
| **Join a newsletter / community** | **6** | 70 | 3.5 | 4 | 1 | 54.1 |
| **Watch a video first** | **2** | 85 | 5 | 4 | 3 | 51.3 |
